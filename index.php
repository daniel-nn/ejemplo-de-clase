...
<body>
    ...
    <main>
        ...
        <div class="container-fluid mt-2 mb-5">
            <div class="row">
                <div class="col-4 p-5">
                    <form class="border p-5" action="index.php" method="POST" id="formulario">
                ...
                <div class="col-8">
                   ...
                   <img src="img/deportistas" alt="deportistas" class="img-fluid w-100"> 
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-6 p-5 text-end text-white">
                    <p>Daniel Andres Garcia Zapata &copy;</p>
                ...
                <div class="col-6 p-5 text-white">
                    ...
                    <p>&#9751; daniel-garcia-@hotmail.com.com</p>
                    <p>&phone;3044522991</p>
                </div>
            </div>
        </div>
    </footer>
